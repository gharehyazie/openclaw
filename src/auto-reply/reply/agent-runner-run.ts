...
import { handleActiveSteerAdmission } from "./agent-runner-active-steer.js";
import {
...
export async function runReplyAgent(
  ...
  if (effectiveShouldSteer && isActive && opts?.messageInjectionAttempted !== true) {
    ...
    await handleActiveSteerAdmission({
      ...
      typingShouldStartImmediately: typingSignals.shouldStartImmediately,
    });
    return undefined;
  }
