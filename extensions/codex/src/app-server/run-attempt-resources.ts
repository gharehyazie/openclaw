    ...
    return {
      configPatch: state.nativeHookRelay
        ? buildCodexNativeHookRelayConfig({
            ...
            // Intersect the route's frozen surface with this attempt's policy: an
            // adopted registration rejects events outside its frozen set (fail-closed),
            // and this attempt's approval mode may suppress events the route allows.
